...
```notes
Really we don't.  Its just argumentation around different ways of sending a document.
What we're really arguing about is tooling.  XML's story is difficult and struggles.
